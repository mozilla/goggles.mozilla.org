  ...
  return {
    ...
    publishData: function(options) {
      ...
      return function(req, res, next) {
        ...
        // TODO: make valet requires an underscore for content URLs,
        //       but is being updated to take a non-suffixed content
        //       URL as a special make property. Update this once we can.
        var makeValetContentSuffix = "_",
            location = req.publishLocation + makeValetContentSuffix,
