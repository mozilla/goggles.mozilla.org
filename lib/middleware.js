module.exports = function middlewareConstructor(env) {
  ...
  return {
    ...
    checkForPublishData: function(req, res, next) {
      ...
      req.body.titleFragment = req.session.username + "'s hack of";
      req.body.html = req.body.html.replace(">{{username}}'s' hack of", ">" + req.body.titleFragment);
      next();
    },
    ...
    ensureMetaData: function(req, res, next) {
      ...
      req.body.metaData.description = title.replace(req.body.titleFragment, "An X-Ray Goggles hack of");
