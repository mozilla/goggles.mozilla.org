  ...
  return {
    ...
    generateUrls: function(appName, s3Url, domain) {
      ...
      return function(req, res, next) {
        ...
        // Append the title count, if the title is not unique
        req.publishLocation += (req.pageTitleCount ? "-" + req.pageTitleCount : "");
      ...
      return function(req, res, next) {
        var metaData = req.body.metaData,
            options = {
              ...
              contentType: "application/x-ray-goggles",
              // metadata
